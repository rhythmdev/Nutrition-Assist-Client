...
const Card = ({newReview}) => {
    const {userName, photoURL, review, date} = newReview;
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center p-8 rounded-b-lg bg-green-500 text-gray-50">
            <img src={photoURL} alt="" className="w-16 h-16 mb-2 -mt-16 bg-center bg-cover rounded-full bg-gray-500 bg-gray-300" />
